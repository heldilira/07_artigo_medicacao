...
```{r}
#| label: ✅ barras por medicamento (filtrado para > 45)

bar_plot_filtered <- sum_df |> 
...
ggplot2::ggsave("img/bar_plot_filtered.png", plot = bar_plot_filtered, width = 10, height = 6, dpi = 300)
```
